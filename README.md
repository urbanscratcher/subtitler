...
3. 타임스탬프와 자막을 한 줄씩 입력하거나 **음성에서 생성**을 누릅니다.
...
Node.js 서버는 HTML과 JavaScript만 제공합니다. 영상 파일과 렌더링 결과를 저장하지 않습니다. 음성 인식도 브라우저에서 실행되며, 최초 사용 시 Whisper 모델 파일만 내려받아 브라우저 캐시에 저장합니다.
